...
# Ian's iMac (MSS 340)
# FULL.d <- read_sav("/Users/ianscotnesbitt/Desktop/ISN Data/1997-2001 Transcript Study.sav")
# dim(FULL.d)

# rawd <- read_sav("/Users/ianscotnesbitt/Desktop/ISN Data/1997-2001 Transcript Study.sav")
...
FULL.d2$student <- as.factor(FULL.d2$personidentifier)
...
LAG.d <- unique(FULL.d2[, c("student",
                           "goal9701",
                           "goal9702",
                           "goal9703",
                           "goal9704",
...
FULL.d2 <- merge(x=FULL.d2, y=LAG.d, by = "student", all.x = TRUE)
LAG.d %>%  View

# Rename the columns as field-types
names(FULL.d2)[164:181] = c("goal9701",
                         "goal9702",
                         "goal9703",
                         "goal9704",
                         "goal9705",
...
AMB.d <- unique(FULL.d2[, c("student",
                           "goal9701",
                           "goal9702",
                           "goal9703",
                           "goal9704",
...
CON.d <- unique(FULL.d2[, c("student",
                           "goal9707",
                           "goal9708",
                           "goal9713")])
...
FULL.d2$ambition.conventional <- (FULL.d2$goal9707 + FULL.d2$goal9708 + FULL.d2$goal9713)/3
FULL.d2$ambition.conventional <- scale(FULL.d2$ambition.conventional, center = TRUE)

# Conventional ambition scale (without "Be Successful in own Business" item)
FULL.d2$ambition.conventional.reduced <- (FULL.d2$goal9707 + FULL.d2$goal9708)/2
FULL.d2$ambition.conventional.reduced <- scale(FULL.d2$ambition.conventional.reduced, center = TRUE)
```
...
PWR.d <- unique(FULL.d2[, c("student",
                           "goal9704",
                           "goal9705",
                           "goal9718",
                           "goal9719")])
...
FULL.d2$ambition.power <- (FULL.d2$goal9704 + FULL.d2$goal9705 + FULL.d2$goal9718 + FULL.d2$goal9719)/4
FULL.d2$ambition.power <- scale(FULL.d2$ambition.power, center = TRUE)
```
...
SCI.d <- unique(FULL.d2[, c("student",
                           "goal9702",
                           "goal9703",
                           "goal9710")])
...
FULL.d2$ambition.scientific <- (FULL.d2$goal9702 + FULL.d2$goal9703 + FULL.d2$goal9710)/3
FULL.d2$ambition.scientific <- scale(FULL.d2$ambition.scientific, center = TRUE)
```
...
ART.d <- unique(FULL.d2[, c("student",
                           "goal9701",
                           "goal9711",
                           "goal9712")])
...
FULL.d2$ambition.artistic <- (FULL.d2$goal9701 + FULL.d2$goal9711 + FULL.d2$goal9712)/3
FULL.d2$ambition.artistic <- scale(FULL.d2$ambition.artistic, center = TRUE)
```
...
SOJ.d <- unique(FULL.d2[, c("student",
                            "goal9709",
                            "goal9714",
                            "goal9716",
                            "goal9717")])
...
FULL.d2$ambition.socialjustice <- (FULL.d2$goal9709 + FULL.d2$goal9714 + FULL.d2$goal9716 + FULL.d2$goal9717)/4
FULL.d2$ambition.socialjustice <- scale(FULL.d2$ambition.socialjustice, center = TRUE)
```

# DATA CLEANING PART IV: COVARIATES

```{r Factoring and Recoding Sex}
FULL.d2$sex.numerical <- as.numeric(FULL.d2$sex)-1

FULL.d2$sex <- as.factor(FULL.d2$sex)
FULL.d2$sex <- dplyr::recode(FULL.d2$sex,
                    `1` = "Male",
                    `0` = "Female")
                    
FULL.d2$sex <- fct_relevel(FULL.d2$sex, "Male")
```

```{r Factoring and Renaming School Year}
FULL.d2$schoolyear.numerical <- FULL.d2$schlyear
FULL.d2$schoolyear <- as.factor(FULL.d2$schlyear)
```

```{r Factoring and Renaming Students' Level of Financial Concern}
FULL.d2$financialconcern.numerical <- as.numeric(FULL.d2$fincon)

FULL.d2$financialconcern <- as.factor(FULL.d2$fincon)
FULL.d2$financialconcern <- dplyr::recode(FULL.d2$financialconcern,
...
FULL.d2$nativeenglish.numerical <- as.numeric(FULL.d2$natengsp)

FULL.d2$nativeenglish <- as.factor(FULL.d2$natengsp)
FULL.d2$nativeenglish <- dplyr::recode(FULL.d2$nativeenglish,
                    '2'= "Native Speaker",
...
FULL.d2$highschoolgpa <- scale(FULL.d2$hsgpa, center = TRUE)
```
...
FULL.d2$satscore <- as.numeric(FULL.d2$t_total)

# Dropping unrealistically low scores
FULL.d2$satscore[FULL.d2$satscore < 200] <- NA 

# Centering test scores
FULL.d2$satscore <- scale(FULL.d2$satscore, center = TRUE)
```

```{r Relabling and Centering Political ID}
FULL.d2$politicalid <- scale(FULL.d2$politpr2, center = TRUE)
```

```{r Factoring and Recoding Age}
FULL.d2$agegroup.numerical <- as.numeric(FULL.d2$age)

FULL.d2$agegroup <- as.factor(FULL.d2$age)
FULL.d2$agegroup <- dplyr::recode(FULL.d2$agegroup,
...
FULL.d2$race01 <- as.numeric(FULL.d2$race01)-1
FULL.d2$race02 <- as.numeric(FULL.d2$race02)-1
FULL.d2$race03 <- as.numeric(FULL.d2$race03)-1
FULL.d2$race04 <- as.numeric(FULL.d2$race04)-1
FULL.d2$race05 <- as.numeric(FULL.d2$race05)-1
FULL.d2$race06 <- as.numeric(FULL.d2$race06)-1
FULL.d2$race07 <- as.numeric(FULL.d2$race07)-1
FULL.d2$race08 <- as.numeric(FULL.d2$race08)-1
FULL.d2$race09 <- as.numeric(FULL.d2$race09)-1
FULL.d2$race10 <- as.numeric(FULL.d2$race10)-1
FULL.d2$race11 <- as.numeric(FULL.d2$race11)-1
FULL.d2$race12 <- as.numeric(FULL.d2$race12)-1
FULL.d2$race13 <- as.numeric(FULL.d2$race13)-1

# Sum of all race scores to determine how many people identify with how many races
FULL.d2$racecount <- rowSums(FULL.d2[, c("race01",
                                       "race02",
                                       "race03",
                                       "race04",
                                       "race05",
...
table(FULL.d2$racecount)
```

```{r Relabeling and Recoding Race Variables}
# White
FULL.d2$race.white <- as.factor(FULL.d2$race01)
FULL.d2$race.white <- dplyr::recode(FULL.d2$race.white,
                               '1' = "White",
                               '0' = "Non-White")

# Black
FULL.d2$race.black <- as.factor(FULL.d2$race02)
FULL.d2$race.black <- dplyr::recode(FULL.d2$race.black,
                            '1' = "Black",
                            '0' = "Non-Black")

# Native American
FULL.d2$race.nativeamerican <- as.factor(FULL.d2$race03)
FULL.d2$race.nativeamerican <- dplyr::recode(FULL.d2$race.nativeamerican,
                            '1' = "NativeAmerican",
                            '0' = "Non-NativeAmerican")

# Mexican
FULL.d2$race.mexican <- as.factor(FULL.d2$race04)
FULL.d2$race.mexican <- dplyr::recode(FULL.d2$race.mexican,
                            '1' = "Mexican",
                            '0' = "Non-Mexican")
# Puerto Rican
FULL.d2$race.puertorican <- as.factor(FULL.d2$race05)
FULL.d2$race.puertorican <- dplyr::recode(FULL.d2$race.puertorican,
                            '1' = "PuertoRican",
                            '0' = "Non-PuertoRican")


# Other Latino
FULL.d2$race.otherlatino <- as.factor(FULL.d2$race06)
FULL.d2$race.otherlatino <- dplyr::recode(FULL.d2$race.otherlatino,
                            '1' = "OtherLatino",
                            '0' = "Non-OtherLatino")

# Chinese
FULL.d2$race.chinese <- as.factor(FULL.d2$race07)
FULL.d2$race.chinese <- dplyr::recode(FULL.d2$race.chinese,
                            '1' = "Chinese",
                            '0' = "Non-Chinese")

# Filipino
FULL.d2$race.filipino <- as.factor(FULL.d2$race08)
FULL.d2$race.filipino <- dplyr::recode(FULL.d2$race.filipino,
                            '1' = "Filipino",
                            '0' = "Non-Filipino")

# Japanese
FULL.d2$race.japanese <- as.factor(FULL.d2$race09)
FULL.d2$race.japanese <- dplyr::recode(FULL.d2$race.japanese,
                            '1' = "Japanese",
                            '0' = "Non-Japanese")


# Korean
FULL.d2$race.korean <- as.factor(FULL.d2$race10)
FULL.d2$race.korean <- dplyr::recode(FULL.d2$race.korean,
                            '1' = "Korean",
                            '0' = "Non-Korean")


# Southeast Asian
FULL.d2$race.southeastasian <- as.factor(FULL.d2$race11)
FULL.d2$race.southeastasian <- dplyr::recode(FULL.d2$race.southeastasian,
                            '1' = "SoutheastAsian",
                            '0' = "Non-SoutheastAsian")


# Other Asian
FULL.d2$race.otherasian <- as.factor(FULL.d2$race12)
FULL.d2$race.otherasian <- dplyr::recode(FULL.d2$race.otherasian,
                            '1' = "OtherAsian",
                            '0' = "Non-OtherAsian")


# Other
FULL.d2$race.other <- as.factor(FULL.d2$race13)
FULL.d2$race.other <- dplyr::recode(FULL.d2$race.other,
                            '1' = "Other",
                            '0' = "Non-Other")
```
...
FULL.d2 <- FULL.d2 %>% mutate(religion =
                                                                        ...
                                                                        ifelse(relig97d %in% c(3,13,15), "OtherChristian",
                                                                               ifelse(relig97d %in% c(2,16), "OtherReligion",
                                                                                      ifelse(relig97d ==17, "None",
                                                                                             relig97d)))))))))
FULL.d2$religion <- fct_relevel(FULL.d2$religion, "None")

# Mplus version
FULL.d2$religion.numerical <- dplyr::recode(FULL.d2$religion,
                            'Protestant' = 1,
                            'Catholic' = 2,
                            'Jewish' = 3,
                            'Mormon' = 4,
...
# Born Again
FULL.d2$bornagain <- as.factor(FULL.d2$bornagin)
FULL.d2$bornagain <- dplyr::recode(FULL.d2$bornagain,
                            '2' = "BornAgain",
                            '1' = "Non-BornAgain")
# Mplus version
FULL.d2$bornagain.numerical <- (FULL.d2$bornagin)-1
```
...
FULL.d2$grade.alphabetical <- as.factor(FULL.d2$grade)
summary(FULL.d2$grade.alphabetical)

# Relabeling and checking numerical grades
FULL.d2$grade.numerical <- FULL.d2$`grade#`
summary(FULL.d2$grade.numerical)
```
...
COURSECOUNT.d <- aggregate(
  cbind(FULL.d2$business.numerical,
        FULL.d2$economics.numerical,
        FULL.d2$mathematics.numerical,
        FULL.d2$lifesciences.numerical,
        FULL.d2$sportssciences.numerical,
        FULL.d2$physicalsciences.numerical,
        FULL.d2$socialsciences.numerical,
        FULL.d2$education.numerical,
        FULL.d2$humanities.numerical,
        FULL.d2$performingarts.numerical,
        FULL.d2$engineering.numerical,
        FULL.d2$music.numerical,
        FULL.d2$finearts.numerical
    ),
  by=list(
    Category=FULL.d2$student
    ),
  FUN=sum
  )
...
RACE.d <- unique(FULL.d2[, c("student",
                            "race.white",
                            "race.black",
                            "race.nativeamerican",
                            "race.mexican",
...
FULL.d2.no.na <- subset(FULL.d2, !is.na(grade.numerical))

# Create descriptive outputs
conambdf <- varDescribe(FULL.d2.no.na$ambition.conventional)
powerambdf <- varDescribe(FULL.d2.no.na$ambition.power)              
scienceambdf <- varDescribe(FULL.d2.no.na$ambition.scientific)
artsambdf <- varDescribe(FULL.d2.no.na$ambition.artistic)
socialjambdf <- varDescribe(FULL.d2.no.na$ambition.socialjustice)
...
# Business
sum(FULL.d2$business.numerical)
summary(FULL.d2$business)

# Economics
sum(FULL.d2$economics.numerical)
summary(FULL.d2$economics)

# Mathematics
sum(FULL.d2$mathematics.numerical)
summary(FULL.d2$mathematics)

# Engineering
sum(FULL.d2$engineering.numerical)
summary(FULL.d2$engineering)

# Physical Sciences
sum(FULL.d2$physicalsciences.numerical)
summary(FULL.d2$physicalsciences)

# Social Sciences
sum(FULL.d2$socialsciences.numerical)
summary(FULL.d2$socialsciences)

# Life Sciences
sum(FULL.d2$lifesciences.numerical)
summary(FULL.d2$lifesciences)

# Sports Sciences
sum(FULL.d2$sportssciences.numerical)
summary(FULL.d2$sportssciences)

# Education
sum(FULL.d2$education.numerical)
summary(FULL.d2$education)

# Humanities
sum(FULL.d2$humanities.numerical)
summary(FULL.d2$humanities)

# Fine Arts
sum(FULL.d2$finearts.numerical)
summary(FULL.d2$finearts)

# Performing Arts
sum(FULL.d2$performingarts.numerical)
summary(FULL.d2$performingarts)

# Music
sum(FULL.d2$music.numerical)
summary(FULL.d2$music)

length(unique(FULL.d2$course))
length(unique(FULL.d2.no.na$course))

#unique(FULL.d2$course)
```
...
MPLUS.COURSE.d %>% summary

# Write out a .csv with no row or column names
#write.table(MPLUS.COURSE.d, "/Users/ianscotnesbitt/Desktop/ISN Data/MPLUSCOURSEd for RnR.csv", sep = ",", col.names =FALSE, row.names = FALSE)
```

```{r Data Export for GPA Mediations in Mplus}
# New object
MPLUS.GPA.d <- FULL.d2[, c("student",
...
# Write out a .csv with no row or column names
#write.table(MPLUS.GPA.d, "/Users/ianscotnesbitt/Desktop/ISN Data/MPLUSGPAd for RnR.csv", sep = ",", col.names =FALSE, row.names = FALSE)
```
...
lm.cc1 <- xx lmer(grade.numerical ~
                 sex +
                 agegroup +
                 race.black +
                 race.nativeamerican +
...
lm.cc2 <- xx lmer(grade.numerical ~
                 sex +
                 agegroup +
                 race.black +
                 race.nativeamerican +
                 ...
                 ambition.socialjustice +
                  (schoolyear|student) + 
                  (1|course),
data = FULL.d2, control=lmerControl(check.nobs.vs.nlev = "ignore",
     check.nobs.vs.rankZ = "ignore",
     check.nobs.vs.nRE="ignore")
               )
